...
const TransformGlobe = () => {
  ...
  useEffect(() => {
    ...
    const initTimeout = setTimeout(() => {
      ...
      // Animation sequence with enhanced text animations
      tl
  ...
  return (
    <section
      ref={sectionRef}
      className="TransformGlobe relative h-screen overflow-hidden"
      style={{
        zIndex: 1,
        marginTop: 0,
        paddingTop: 0,
    ...
    >
      ...
      <div
        ref={backgroundRef}
        className="absolute inset-0 w-full h-full bg-gradient-to-r from-[#d0eed0] to-[#a6bba1]"
        style={{
