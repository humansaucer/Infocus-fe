    ...
    <section className="relative w-full">
      ...
      <div className="sticky top-0 min-h-[20vh] sm:min-h-[100vh] lg:min-h-[60vh] w-full z-10">
        <div className="w-full h-full flex flex-col-reverse lg:flex-row lg:items-center gap-10 bg-white">
          ...
          {/* Text Container */}
          <div className="w-full lg:w-1/2 text-black lg:items-center font-bandeins-strange px-2 sm:px-4 flex text-left sm:text-left md:text-left lg:text-left text-[28px] xs:text-[32px] sm:text-[36px] md:text-[54px] lg:text-[67px] leading-[.99]">
